...
{
    public class LimitePayPalDecorator : FormaPagamentoDecorator
    {
        private double _limite;

        public LimitePayPalDecorator(IFormaPagamento formaPagamento, double limite) : base(formaPagamento)
        {
            _limite = limite;
        }
